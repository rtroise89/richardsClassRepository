...
*Outputs a matrix of values depending on the format of the input. Ex: If we simply add numbers seperated by comma, the matrix will output one row of x columns. Another is to assign sets of numbers to tags which forces those sets to rows.
```{r}
