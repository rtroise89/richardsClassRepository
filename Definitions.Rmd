...
```{r}
  write.table(c(1,2,3,4,5,6), "abc3.txt")
```
...
*Outputs a matrix of values depending on the format of the input.One way is to simply add numbers seperated by commas ()